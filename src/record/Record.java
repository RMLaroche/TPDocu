...
/**
 * ******************************************************************* class:
 * The Record class' purpose is to read and write records to a randomaccess
 * file.
 *******************************************************************/
public class Record {
	private int recID;
	...
	public void ReadRec(RandomAccessFile file) throws IOException {
		...
		/**
		 * Read characters until we get to ;;; which indicates the end of the record
		 */
		while (ii < loopCtl) {
			ch = file.readChar();
			str = str + ch;
	...
	/**
	 * ******************************************************** The fill() method is
	 * used to fill in the passed string with blanks.
	 */
	...
	/**
	 * ************************************************************ write() Writes a
	 * record to the specified RandomAccessFile.
	 */
	...
	/**
	 * ******************************************************** Method:
	 * writeInteger() is used to wite an integer to the randomaccess file.
	 ********************************************************/
	...
	/**
	 * ****************************************************************** NOTE: This
	 * method contains a hard coded value for the size of a record of information.
	 * The value is arrived at by adding up the size Java allocates to each data
	 * type writeChars(String s) Writes every character in the string s, to the
	 * output stream, in order, two bytes per character. The data Record is five
	 * strings of 45 characters each and two int data types.
	 *
	 */
