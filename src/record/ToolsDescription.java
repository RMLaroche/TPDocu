...
public class ToolsDescription {
	...
	public static List<String[][]> getAllTools(){
		...
		List<String[][]> allTools = new ArrayList<String[][]>();
		
		allTools.add(lawnMower);
		allTools.add(lawnTractor);
		allTools.add(handDrill);
		allTools.add(drillPress);
		allTools.add(hammer);
		allTools.add(bandSaw);
		allTools.add(sanders);
	   ...
	   public static String lawnMower[][]  = {
	   ...
	   public static String lawnTractor[][]  = {
	   ...
	   public static String handDrill[][]  = {
